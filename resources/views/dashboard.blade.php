...
@section('content')
  <div class="container">
    ...
    <div class="row">
      ...
      <!--  The Content -->
      <div class="col-md-9 col-md-offset-3 well admin-content" id="home">
        <h3 class="lato text-center">
          <span class="btn btn-primary btn-block hidden-xs">Daftar Layanan </span>
          <a href="{{route('layanan.index')}}"><span class="btn btn-primary btn-block visible-xs">Daftar Layanan </span></a>
        </h3>
        <br>
      ...
      <div class="col-md-9 col-md-offset-3 well admin-content" id="widgets">
          Widgets
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="pages">
          Pages
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="charts">
          Charts
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="table">
          Table
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="forms">
          Forms
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="calender">
          Calender
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="library">
          Library
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="applications">
          Applications
      </div>
      <div class="col-md-9 col-md-offset-3 well admin-content" id="settings">
          Settings
      </div>
    </div>
  </div>
