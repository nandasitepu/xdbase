...
@section('content')
  @include('layouts._navtop')
    <div class="container" style="padding-bottom:100px">
      <div class="row">
        <div class="col-md-12">
          <h3><span class="label label-default">Edit Penyedia</span></h3>
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              {!! Form::model($penyedia,['route'=>['penyedia.update', $penyedia->id], 'method' => 'PUT', 'files' => true, 'class' => 'form-group']) !!}
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  {{ Form::submit('Edit Penyedia', ['class' => 'btn btn-sm btn-block btn-default', 'style' =>'margin-top:20px'])}}
                </div>
              </div>
              {!! Form::close() !!}
            </div>
